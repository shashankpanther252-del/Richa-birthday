...
/* ===== TYPEWRITER LETTER ===== */
const letterText = `Dear Richa,\n\nHappy Birthday!\n\nWe have never met, and you don't know me personally. That is completely okay.\n\nInstead of writing just another 'Happy Birthday' comment, I wanted to create something a little different — a small website made with time, effort, and genuine respect.\n\nYour journey in some ways has inspired me to work harder toward my own goals.\n\nOne moment that has always stayed with me was an interview where your father kissed you on the forehead and spoke so proudly about you. It reflected such a beautiful bond between both of you, and it was genuinely heartwarming to watch. Seeing the bond between a father and daughter, and the pride and happiness in your father's eyes, genuinely inspired many of us to work harder and do something meaningful so that one day our own fathers can look at us with the same pride. That pride takes a lot of eforts to earn.\n\nI have admired your performances since Mahabharat and I have also enjoyed watching your videos over the years.\n\nI simply hope this little surprise brings a smile to your face on your special day.\n\nWishing you happiness, good health, success, and many memorable moments ahead.\n\nA small birthday gift from Shashank Gupta ❤️`;
